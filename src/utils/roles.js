...
export const MENU_SECTIONS = [
  {
    ...
    items: [
      ...
      { to: '/work-permits', label: 'Work Permits', minTier: 'manager' },
      { to: '/equipment-registry', label: 'Equipment', minTier: 'manager' },
      { to: '/hazard-zones', label: 'Hazard Zones', minTier: 'manager' },
      { to: '/contractors', label: 'Contractors', minTier: 'manager' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/safety-drills', label: 'Safety Drills', minTier: 'manager' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/incident-forecast', label: 'Incident Forecast', minTier: 'manager' },
